$projectPath="VersionOne.Integration.Tfs.Policy.Deployment.VS2013"
$pkgdir="chocolateyPackage"
$nuspec="VersionOne.Integration.Tfs.Policy.VS2013.nuspec"
$filebasename="VersionOne.Integration.Tfs.Policy.Deployment.VS2013"
$configuration="Release"
$ps1file="Install.ps1"
$pkgid="VersionOne.Integration.Tfs.Policy.VS2013"
